...
public sealed class DoctorAttendantMapperTests
{
    ...
    public void DomainPageListToResponsePageList_SuccessfulScenario_ReturnsResponsePageList()
    {
        ...
        var doctorAttendat = DoctorAttendantBuilder
            .NewObject()
            .WithScheduleList(scheduleList)
            .WithSpecialityList(specialityList)
            .DomainBuild();
    ...
    public void FilterRequestToArgumentDomain_SuccessfulScenario_ReturnsDomainObject()
    {
        ...
        var doctorGetAllFilterRequest = DoctorAttendantBuilder
            .NewObject()
            .WithSpecialityIdList(specialityIdList)
            .GetAllFilterRequestBuild();
